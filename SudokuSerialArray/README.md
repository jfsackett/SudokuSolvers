...
3. Open shell and change to Serial Solver project root: **&lt;install-path&gt;/SudokuSolvers/SudokuSerialArray**
...
4. Single source code file: **&lt;project-root&gt;/src/main/scala/sudoku/serial/SolveSerialArrayApp.scala**
